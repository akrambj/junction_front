...
const Hero = () => {
  return (
    <div className="w-[97%] lg:h-[100vh] lg:overflow-hidden mx-auto flex flex-col justify-center gap-y-7 sm:flex-col-reverse">
      <img className="md:w-[60%] mx-auto" src={hero} alt="" />
      <div className="flex flex-col sm:items-center sm:justify-center gap-5 py-4 sm:gap-y-4 md:w-[70%] md:mx-auto">
        ...
        <div className="text-left">
          <button className="bg-[#00B4D8] text-white px-10 py-2 text-xl font-bold rounded-md">
            Try It
          </button>
        </div>
      </div>
